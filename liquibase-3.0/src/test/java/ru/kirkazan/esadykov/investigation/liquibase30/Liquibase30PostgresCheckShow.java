package ru.kirkazan.esadykov.investigation.liquibase30;
 ...
 */
public class Liquibase30PostgresCheckShow
{
    ...
    public void showBadChecks() throws LiquibaseException
    {
        ...
        Liquibase lb = new Liquibase(
                "ru/kirkazan/esadykov/investigation/liquibase30/liquibase-3.0-bad-postgres-check-show.xml",
    ...
    public void showGoodChecks() throws SQLException, LiquibaseException
    {
        Database db = DatabaseFactory.getInstance().findCorrectDatabaseImplementation(new JdbcConnection(connection));
        Liquibase lb = new Liquibase(
                "ru/kirkazan/esadykov/investigation/liquibase30/liquibase-3.0-good-postgres-check-show.xml",
                new ClassLoaderResourceAccessor(),
                db
        );
        lb.update("");
